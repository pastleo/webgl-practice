    ...
    if (input.mousedown) {
      ...
      if (
        ...
        if (input.mousedown === 'left') {
          ...
          calcAndMoveCameraAngle(game, offsetX, offsetY, preOffsetX, preOffsetY);
        }
...
export function calcAndMoveCameraAngle(game, offsetX, offsetY, preOffsetX, preOffsetY) {
  moveCameraAngle(game, [
    (preOffsetY - offsetY) / 100,
    (preOffsetX - offsetX) / (100 * window.devicePixelRatio)
  ])
}
