...
export default function listenToInputs(canvas, game) {
  ...
  canvas.addEventListener('mousemove', event => {
    ...
    const pointingObjId = renderAndGetPointingObjectId(gl, game, [event.offsetX, event.offsetY]);
    if (pointingObjId !== game.pointingObjId) {
      console.log('pointing:', pointingObjId);
      game.pointingObjId = pointingObjId;
    }
  })
