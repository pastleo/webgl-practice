...
function renderMirrorTexture(gl, game, projectionMatrix, time) {
  ...
  twgl.setUniforms(game.rendering.programs.main, {
    ...
    u_originFogNear: 100.0,
    u_originFogFar: 100.0,
  });

  drawCones(gl, game.rendering, game.rendering.programs.main);
  renderSkybox(gl, game, projectionMatrix, mirroredViewMatrix, time);
