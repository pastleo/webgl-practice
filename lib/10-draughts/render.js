...
export default function render(game, time) {
  ...
  twgl.setUniforms(game.rendering.programs.main, {
    ...
    u_glowFactor: Math.sin(time * 0.002),
  });
...
export function renderObjects(gl, rendering, programInfo, enableBlend) {
  ...
  { // draw availableCoords / discs
    ...
    gl.drawElementsInstanced(
      gl.TRIANGLES,
      rendering.bufferVaos.disc.bufferInfo.numElements,
      rendering.bufferVaos.disc.bufferInfo.elementType,
      0, // offset
      rendering.bufferVaos.disc.bufferInfo.instance,
    );
  }
