...
import { allPieceCorrds, pieceCoordTranslation, pieceGlow, availableCoordsObjectId } from './utils.js';
import { pieceTeamDiffuseMap, glowColor } from './consts.js';
...
export default function initRendering(game) {
  ...
  bufferVaos.disc = initInstancedBufferVao(gl, programs.main,
    ...
    [
      ...
      ['ai_objectId', 4, c => encodeIntVec4(availableCoordsObjectId(c, game))],
      ['ai_emission', 3, () => ([0, 0, 0])],
      ['ai_glow', 3, () => glowColor],
    ],
    game.chosenPieceI ? game.pieces[game.chosenPieceI - 1].availableCoords : [],
  );
