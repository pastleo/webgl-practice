...
void main() {
  ...
  col += (1.0 - length(cubeCoord - vec3(COS30, 0, -SIN30)) / 2.0) * u_background[0];
  col += (1.0 - length(cubeCoord - vec3(-COS30, 0, -SIN30)) / 2.0) * u_background[1];
  col += (1.0 - length(cubeCoord - vec3(0, 0, 1)) / 2.0) * u_background[2];
